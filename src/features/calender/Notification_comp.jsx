...
function Notification_comp() {
    ...
    return (
        <div className="bg-white rounded-xl p-3 xl:px-6 h-full overflow-y-auto shadow-sm scrollbar-hide flex flex-col">
            <div className="xl:my-4 2xl:text-3xl w-full bg-white h-[20%] p-1">
                <p className="p-1">New Notification</p>
            </div>

            <div className="scrollbar-hide">
                <div className="flex flex-col gap-2.5 xl:gap-5 3xl:gap-8 mt-2 items-center">
                    {notificationArray.map((data) => (
                        <div key={data.id} className="flex gap-2 xl:gap-4 2xl:gap-4 3xl:gap-[33px] 4xl:gap-[68px] xs:text-[8px] sm:text-[12px] lg:text-[9px] w-full xl:text-[12px] 2xl:text-[15px] 3xl:text-[19px] 4xl:text-3xl items-center ">
