...
function RequestModal({ id }) {
    ...
    return (
        <div className="bg-white min-w-[280px] 3xl:w-[640px] mx-auto rounded-3xl p-5 relative">
            <p
                onClick={handleClose}
                className='absolute right-6 top-6 border border-black rounded-full cursor-pointer text-[20px] 3xl:text-[38px]'><MdClose />
            </p>
            ...
            <div className="flex flex-col items-center text-xs">
                <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHByb2ZpbGV8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
                    alt="" className="w-16 h-16 3xl:w-36 3xl:h-36 rounded-full object-cover object-center" />
                ...
                {accept ? (
                    ...
                    <>
                        ...
                        <div className="flex gap-4 items-center mt-2">
                            <button onClick={handleAccept} className="p-3 px-5 rounded-xl text-white bg-black">Accept</button>
                            <button onClick={handleClose} className="p-3 px-5 rounded-xl bg-white border ">Cancel</button>
                        </div>
                    </>
                )}
