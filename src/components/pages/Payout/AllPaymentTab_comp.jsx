    ...
    return (
        <div className='h-full'>
            <div className='overflow-x-scroll md:overflow-x-hidden h-full'>
                <div id="table" className=" w-full text-[14px] scrollbar-hide p-2 h-full">
                    ...
                    <div id="table-body" className='paytable scrollbar-hide'>
                        {
                            payoutTableData.map((data) => (
                                <ul key={data.id} className=" flex justify-between items-center py-2 bg-white mb-4 rounded-full font-semibold">
