        ...
        <div>
            <div className="flex flex-col md:flex-row gap-8 lg:gap-4 xl:gap-8 items-center w-full mt-4">
                <div className="flex flex-col bg-indigo-100 rounded-xl p-4 gap-4 w-full md:w-[25%] shadow-sm py-6">
                    <div className="flex flex-col lg:text-[10px] text-[12px] xl:text-[12px] 3xl:text-xl text-start">
                        <p className="font-semibold">Current Balance</p>
                        <p>Today</p>
                    </div>
                    <div className="">
                        <p className="lg:text-lg text-xl xl:text-xl 3xl:text-4xl py-1 font-semibold">
                            $23,256.23
                        </p>
                    </div>
                </div>
